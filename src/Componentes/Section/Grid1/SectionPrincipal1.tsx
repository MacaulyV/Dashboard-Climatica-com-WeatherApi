          ...
          <div className={styles.Low1}>
            ...
            <div className={styles.MiniBox}>
              <img
                ...
                onClick={handleClick}
              />
              <p className={styles.SubParagrafo2}>Umidade do ar</p>
              <p className={styles.Valor2}>{localClima.umidade}%</p>
            </div>
            <div className={styles.MiniBox}>
              <img
                ...
                onClick={handleClick}
              />
              <p className={styles.SubParagrafo3}>Sensação termica</p>
              <p className={styles.Valor3}>
